...
router.post(    '/',           TechnologyController.create);                                                    // C
router.get(     '/',           passport.authenticate('jwt', {session:false}), TechnologyController.get);        // R
//router.get(     '/all',        passport.authenticate('jwt', {session:false}), TechnologyController.getAll);     // R
